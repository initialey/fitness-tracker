...
実行日: 2026-09-19 ／ 固定時刻 2026-09-16 06:50 (Asia/Manila) ／ Chromium 390×844
...
| その日の Day（部位）を変更できる: 今日だけ差し替え／ここから順番をずらす／記録済み警告／連続日の注意／休みの日への変更／週まとめとレポートへの反映／元に戻す | ✓ | ✓ | 今日だけ差し替え・ここから順番をずらす・記録済み警告・連続日の注意・休みの日への変更・週まとめ/レポートへの反映・元に戻す、すべて確認 / 今日だけ差し替え・ここから順番をずらす・記録済み警告・連続日の注意・休みの日への変更・週まとめ/レポートへの反映・元に戻す、すべて確認 |
