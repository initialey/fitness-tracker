...
合計 63 項目 ／ NG 0 件 ／ ページエラー mock 0 件・db 0 件
...
| 数だけの表示（7種、1種）がない | ✓ | ✓ |  |
| 同日に2回開いても二重保存されない | ✓ | ✓ | db のみ / docs: {"log_workout":5,"plan_days":7,"plan_exercises":45,"plan_warmup":6,"plan_meals":5,"plan_supplements":8,"plan_routine":3,"foods":21,"settings":1,"log_weight":2,"log_daily":5,"log_routine":2,"log_meals":1,"log_supplements":2,"log_media":2,"log_cardio":1} |
